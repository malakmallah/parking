...
// Available spots
$stats['available_spots'] = $stats['total_spots'] - $stats['occupied_spots'];

// Recent parking sessions (last 10)
$stmt = $pdo->query("
    SELECT 
        ps.id,
        u.FIRST,
    ...
    JOIN parking_spots spot ON ps.spot_id = spot.id
    LEFT JOIN blocks b ON spot.block_id = b.id
    LEFT JOIN campuses c ON spot.campus_id = c.id
...
$stmt = $pdo->query("
    ...
    FROM campuses c
    LEFT JOIN parking_spots ps ON c.id = ps.campus_id
    LEFT JOIN parking_sessions sess ON ps.id = sess.spot_id AND sess.exit_at IS NULL
    GROUP BY c.id, c.name, c.code
");
$campus_stats = $stmt->fetchAll();
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($session['campus_name'] ?? 'N/A'); ?></td>
                                        <td>
                                            <?php if ($session['block_name']): ?>
                                                Block <?php echo htmlspecialchars($session['block_name']); ?> - 
                                            <?php endif; ?>
                                            Spot <?php echo htmlspecialchars($session['spot_number']); ?>
                                        </td>
                                        <td><?php echo date('M j, Y g:i A', strtotime($session['entrance_at'])); ?></td>
                                        <td>
                                            <span class="status-badge <?php echo $session['exit_at'] ? 'inactive' : 'active'; ?>">
                                                <?php echo $session['exit_at'] ? 'Exited' : 'Parked'; ?>
                                            </span>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                    ...
                    <div class="campus-stats">
                        ...
                        <div class="campus-card">
                            ...
                            <div class="campus-stats-row">
                                ...
                                <div class="campus-stat">
                                    <div class="number"><?php echo number_format($campus['total_spots'] - $campus['occupied_spots']); ?></div>
